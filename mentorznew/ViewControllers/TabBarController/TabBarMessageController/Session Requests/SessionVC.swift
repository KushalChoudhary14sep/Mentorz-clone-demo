...
class SessionVC: UIViewController, CAPSPageMenuDelegate {
    ...
    override func viewDidLoad() {
        ...
        let sentRequest = storyboard1.instantiateViewController(identifier: "SentSessionRequestVC")
        let storyboard2 = UIStoryboard(name: "Main", bundle: nil)
        let recievedRequest = storyboard2.instantiateViewController(identifier: "RecievedSessionRequestVC")
